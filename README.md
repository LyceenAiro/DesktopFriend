...
- [X] 模组覆盖注册逻辑
- [X] 模组管理器: 调整模组注册顺序
- [X] 模组管理器测试、功能调整、bug修复[已测试注册顺序、注册覆盖、图标注册，已支持查看删除ID、修改ID，已修复营养数值调整、buff的状态修正]
- [X] 重构动作触发模组（疲惫，休息，死亡）
- [X] 状态反馈图标（饥饿、渴、生病等）
- [X] 状态图标扩展开发（超过三种状态图标的处理方案、补全濒死、死亡、饥饿、口渴图标）
- [X] 挂机随机buff产生
- [X] 图鉴系统，以及收集进度（如果是debug还支持直接查看全图鉴）
...
睡觉动画    .png    2 帧    与待机动画类似，但是睡觉动画使用动作模组注册
濒死动画    .png    1 帧
死亡动画    .png    1 帧
